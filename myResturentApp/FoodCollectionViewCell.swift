...
class FoodCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        foodImageView = UIImageView(frame: CGRect(x: offset-10, y: offset-10, width: (width*0.80), height: (width*0.80)))
        foodImageView.contentMode = .scaleAspectFill
        foodImageView.clipsToBounds = true
        foodImageView.layer.cornerRadius = (width*0.80) / 2
        ...
        addContraintsWithFormat(format: "H:|-\(width+5)-[v0]|", views: dividerLine)
...
//        containerView.backgroundColor = UIColor.brown
        ...
        addContraintsWithFormat(format: "H:|-\(width+5)-[v0]|", views: containerView)
...
//        foodPrice.backgroundColor = UIColor.blue
        ...
        addContraintsWithFormat(format: "H:|[v0]-\(width-2*offset+5)-|", views: foodName)
        addContraintsWithFormat(format: "V:|-5-[v0(\(height*0.40))]", views: foodName)
        
        addContraintsWithFormat(format: "H:|[v0]-\(width+3*offset)-|", views: foodPrice)
